...
export const HelpCircle57 = ({ className }) => {
  return (
    <svg
      className={`help-circle-57 ${className}`}
      fill="none"
      height="16"
      viewBox="0 0 16 16"
      width="16"
    ...
    >
      <g className="g" clipPath="url(#clip0_3710_7926)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_3710_7926">
