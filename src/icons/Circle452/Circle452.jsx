...
export const Circle452 = ({ className }) => {
  return (
    <svg
      className={`circle-452 ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
    ...
    >
      <g className="g" clipPath="url(#clip0_3710_5995)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_3710_5995">
