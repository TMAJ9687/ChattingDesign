...
export const HelpCircle85 = ({ color = "#98A2B3", className }) => {
  return (
    <svg
      className={`help-circle-85 ${className}`}
      fill="none"
      height="16"
      viewBox="0 0 16 16"
      width="16"
    ...
    >
      <g className="g" clipPath="url(#clip0_469_6393)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_469_6393">
