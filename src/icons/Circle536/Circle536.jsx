...
export const Circle536 = ({ color = "#6941C6", className }) => {
  return (
    <svg
      className={`circle-536 ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
    ...
    >
      <g className="g" clipPath="url(#clip0_3710_3358)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_3710_3358">
